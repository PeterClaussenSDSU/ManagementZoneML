...
strength10 <- arc.strength(model10.dag, model10.dat)
...
strength11 <- arc.strength(model11.dag, model11.dat)
...
strength12 <- arc.strength(model12.dag, model12.dat)
strength.plot(model12.dag, strength12)
...
strength13 <- arc.strength(model13.dag, model13.dat)
strength.plot(model13.dag, strength13)
...
#model4.dag <- model2network("[Y15][Y16|Y15][Y17|Y16:Y15][R18|Y17:Y16:Y15][AR18|R18][Y18|AR18:Y17:Y16:Y15]")
#model4.dag
#graphviz.plot(model4.dag,layout = "dot")
model4.fit = bn.fit(model4.dag, seed.2018.dat[,c('Y18',"R18",'AR18',"Y17",'Y16','Y15')])
model4.fit
bn.fit.qqplot(model4.fit)
strength4 <- arc.strength(model4.dag, seed.2018.dat[,c('Y18',"R18",'AR18',"Y17",'Y16','Y15')])
strength4
strength.plot(model4.dag, strength4)
```

```{r}
model5.dag <- model2network("[Y13][Y14|Y13][Y15|Y14:Y13][Y16|Y15:Y14:Y13][Y17|Y16:Y15:Y14:Y13][R18|Y17:Y16:Y15:Y14:Y13][AR18|R18][Y18|AR18:Y17:Y16:Y15:Y14:Y13][Y19|Y18:Y17:Y16:Y15:Y14:Y13][R20|Y19:Y18:Y17:Y16:Y15:Y14:Y13]")
# we want to compare with sprayed, but there are some missing values
model5.dat <- seed.2018.dat[,c('R20','Y19','Y18',"R18",'AR18',"Y17",'Y16','Y15','Y14','Y13')]
...
strength5
strength.plot(model5.dag, strength5)
```
...
ggpairs(model5.dat, aes(alpha = 0.4))
```
...
model10.fit
bn.fit.qqplot(model10.fit)
strength12 <- arc.strength(model10.dag, model10.dat)
#strength.plot(model10.dag, strength12)
